...
export const candidateAccessTranslations: Record<Language, CandidateAccessTranslation> = {
  "pt-BR": {
    ...
    instructions: [
      ...
      "Durante a aplicação, são registrados eventos técnicos de sessão, visibilidade da aba, carregamento de mídia e modo de entrada para verificar a integridade da execução.",
      "Os eventos técnicos não alteram sua pontuação e não causam eliminação automática. Qualquer consequência exige revisão humana.",
    ],
    consent: "Declaro que li as orientações, a Política de Privacidade e as informações específicas desta participação. Estou ciente de que a empresa responsável tratará meus dados, respostas e eventos técnicos da aplicação para executar esta avaliação, registrar o percurso, verificar a integridade técnica, calcular resultados conforme critérios previamente definidos e cumprir obrigações legais. Esse monitoramento não altera a pontuação nem produz eliminação automática.",
    privacyLink: "Consultar Política de Privacidade",
    privacySummaryTitle: "Privacidade e uso dos dados",
    privacySummaryDescription: "A empresa responsável pelo processo seletivo atua como controladora dos dados. O Práxis atua como operador, seguindo as instruções da empresa. A aplicação registra eventos técnicos explicáveis, separados da pontuação. O cálculo é determinístico, não usa IA generativa para julgar respostas e a decisão final deve permanecer humana.",
    ...
    privacyNotice: "Seus dados e eventos técnicos da aplicação são tratados conforme a LGPD, a Política de Privacidade e as instruções da empresa responsável. O monitoramento de integridade não altera a pontuação nem toma decisão automática. Você pode consultar a Política de Privacidade, solicitar revisão humana e exercer seus direitos nesta página.",
  },
  en: {
    ...
    instructions: [
      ...
      "During the assessment, technical session, tab visibility, media loading, and input-mode events are recorded to verify execution integrity.",
      "Technical events do not change your score or cause automatic elimination. Any consequence requires human review.",
    ],
    consent: "I confirm that I have read the instructions, the Privacy Policy, and the information specific to this participation. I understand that the responsible company will process my data, answers, and technical application events to run this assessment, record the journey, verify technical integrity, calculate results according to predefined criteria, and comply with legal obligations. This monitoring does not change the score or produce automatic elimination.",
    privacyLink: "Read the Privacy Policy",
    privacySummaryTitle: "Privacy and data use",
    privacySummaryDescription: "The company responsible for the recruitment process is the data controller. Praxis acts as a processor following that company's instructions. The application records explainable technical events separately from scoring. Scoring is deterministic, does not use generative AI to judge answers, and the final decision must remain human.",
    ...
    privacyNotice: "Your data and technical application events are processed under the Privacy Policy, applicable rules, and the responsible company's instructions. Integrity monitoring does not change scoring or make an automated decision. You can read the Privacy Policy, request human review, and exercise your rights on this page.",
  },
  "es-MX": {
    loadingLabel: "Preparando",
    ...
    instructions: [
      ...
      "Durante la evaluación se registran eventos técnicos de sesión, visibilidad de la pestaña, carga de medios y modo de entrada para verificar la integridad de la ejecución.",
      "Los eventos técnicos no cambian tu puntuación ni causan eliminación automática. Cualquier consecuencia requiere revisión humana.",
    ],
    consent: "Declaro que leí las indicaciones, la Política de Privacidad y la información específica de esta participación. Entiendo que la empresa responsable tratará mis datos, respuestas y eventos técnicos de la aplicación para ejecutar esta evaluación, registrar el recorrido, verificar la integridad técnica, calcular resultados según criterios predefinidos y cumplir obligaciones legales. Este monitoreo no cambia la puntuación ni produce eliminación automática.",
    privacyLink: "Consultar la Política de Privacidad",
    privacySummaryTitle: "Privacidad y uso de datos",
    privacySummaryDescription: "La empresa responsable del proceso de selección actúa como responsable del tratamiento. Práxis actúa como encargado siguiendo sus instrucciones. La aplicación registra eventos técnicos explicables por separado de la puntuación. El cálculo es determinista, no usa IA generativa para juzgar respuestas y la decisión final debe seguir siendo humana.",
    ...
    privacyNotice: "Tus datos y los eventos técnicos de la aplicación se tratan conforme a la Política de Privacidad, las reglas aplicables y las instrucciones de la empresa responsable. El monitoreo de integridad no cambia la puntuación ni toma una decisión automática. Puedes consultar la Política de Privacidad, solicitar revisión humana y ejercer tus derechos en esta página.",
  },
};
