...
export const candidateAccessTranslations: Record<Language, CandidateAccessTranslation> = {
  "pt-BR": {
    ...
    privacyNotice: "Seus dados e eventos técnicos da aplicação são tratados conforme a LGPD e as instruções da empresa responsável. O monitoramento de integridade não altera a pontuação nem toma decisão automática. Você pode consultar o aviso de privacidade, solicitar revisão humana e exercer seus direitos nesta página.",
  },
  en: {
    ...
    privacyNotice: "Your data and technical application events are processed under applicable privacy rules and the responsible company's instructions. Integrity monitoring does not change scoring or make an automated decision. You can read the privacy notice, request human review, and exercise your rights on this page.",
  },
  "es-MX": {
    loadingLabel: "Preparando",
    ...
    privacyNotice: "Tus datos y los eventos técnicos de la aplicación se tratan conforme a las reglas de privacidad aplicables y las instrucciones de la empresa responsable. El monitoreo de integridad no cambia la puntuación ni toma una decisión automática. Puedes consultar el aviso de privacidad, solicitar revisión humana y ejercer tus derechos en esta página.",
  },
};
