      ...
      <div className="mx-auto max-w-3xl">
        ...
        {integration && (
          <div className="grid gap-6">
            ...
            {/* API própria: webhook de resultados e token de API pública.
                Consolidados aqui — antes viviam na tela separada Configurações → API e Webhooks. */}
            {provider === "CUSTOM_API" && (
              <>
                <WebhookPanel />
                <PublicApiTokenPanel />
  ...
  return (
    <div className="rounded-md border border-border bg-card p-6">
      <div className="flex items-center gap-2">
        ...
        <h2 className="font-medium">Webhook de resultados</h2>
      </div>
      <p className="mt-1 text-sm text-muted-foreground">
        Receba os resultados no seu sistema por webhook assinado (HMAC). Informe a URL de destino,
        escolha os eventos e gere o segredo.
      </p>
  ...
  return (
    <div className="rounded-md border border-border bg-card p-6">
      <div className="flex items-center gap-2">
        ...
        <h2 className="font-medium">Token de API pública</h2>
      </div>
      <p className="mt-1 text-sm text-muted-foreground">
