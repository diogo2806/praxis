...
>(({ className, ...props }, ref) => (
  <thead
    ...
    className={cn(
      "border-b border-border bg-muted/45 text-xs uppercase tracking-wide text-muted-foreground [&_tr]:border-b-0",
      className,
    )}
    {...props}
  />
...
const TableRow = React.forwardRef<HTMLTableRowElement, React.HTMLAttributes<HTMLTableRowElement>>(
  ({ className, ...props }, ref) => (
    <tr
      ...
      data-slot="table-row"
      className={cn(
        "border-b border-border bg-card transition-colors hover:bg-accent/35 data-[state=selected]:bg-accent",
        className,
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => (
  <th
    ...
    className={cn(
      "h-11 px-4 py-3 text-left align-middle text-xs font-semibold tracking-wide text-muted-foreground [&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:translate-y-[2px]",
      className,
    )}
    {...props}
  />
