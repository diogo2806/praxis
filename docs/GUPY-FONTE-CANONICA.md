...
| --- | --- | --- |
| `configurando-webhooks-e-obtendo-payloads-reais` | [Configurando webhooks e obtendo payloads reais](https://developers.gupy.io/v2.0/docs/configurando-webhooks-e-obtendo-payloads-reais) | A referência normativa usa a rota estável da documentação v2.0, sem hífen final. |
...
| `fluxo-de-admissão-para-sistema-de-folha-copy` | [Fluxo de Admissão para Sistema de Folha](https://developers.gupy.io/v2.0/docs/fluxo-de-admiss%C3%A3o-para-sistema-de-folha) | Duplicata com `copy`; a referência normativa usa a rota estável da documentação v2.0. |
