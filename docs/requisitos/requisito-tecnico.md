...
- Commit auditado da branch principal: `d0b2ea8b22b8ae440c9e293f7e7b20f554b0685f`.
...
## 3. Integração Gupy — contrato de entrada
...
3. `INT1` — alinhar os tipos do contrato de entrada da Gupy preservando idempotência e compatibilidade Recrutei.
