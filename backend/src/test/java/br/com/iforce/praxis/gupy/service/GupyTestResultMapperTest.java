...
class GupyTestResultMapperTest {
    ...
    void shouldNotExposeProvisionalScoresBeforeCompletion() {
        ...
        TestResultResponse response = mapper.toResponse(attemptWithStatus(AttemptStatus.IN_PROGRESS, null), simulation);
    ...
    void shouldExposeScoresOnlyAfterRealCompletion() {
        ...
        TestResultResponse response = mapper.toResponse(
                attemptWithStatus(AttemptStatus.COMPLETED, Instant.parse("2026-07-15T12:00:00Z")),
                simulation
        );
