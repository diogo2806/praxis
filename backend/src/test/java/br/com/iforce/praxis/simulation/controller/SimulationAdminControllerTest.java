...
class SimulationAdminControllerTest {
    ...
    @Test
    @Sql(statements = {
            "INSERT INTO candidate_attempts (id, empresa_id, company_id, result_id, simulation_id, simulation_version_id, simulation_version_number, idempotency_key, candidate_name, candidate_email, result_webhook_url, status, score, decision, human_review_required, company_result_string, created_at, started_at, finished_at, anonymized_at) VALUES ('attempt-delete-guard-1', 'empresa-1', '1', 'result-delete-guard-1', 'sim-atendimento-caos', 1, 1, 'idem-delete-guard-1', 'Ana Costa', 'ana@example.com', 'https://cliente.gupy.io/result-webhook', 'COMPLETED', 85, 'RECOMMEND_INTERVIEW', FALSE, 'Resultado Ana', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL)"
    })
    ...
    @Sql(statements = {
            ...
            "INSERT INTO candidate_attempts (id, empresa_id, company_id, result_id, simulation_id, simulation_version_id, simulation_version_number, idempotency_key, candidate_name, candidate_email, result_webhook_url, status, score, decision, human_review_required, company_result_string, created_at, started_at, finished_at, anonymized_at) VALUES ('attempt-match-1', 'empresa-1', '1', 'result-match-1', 'sim-atendimento-caos', 1, 1, 'idem-match-1', 'Ana Costa', 'ana@example.com', 'https://cliente.gupy.io/result-webhook', 'COMPLETED', 85, 'RECOMMEND_INTERVIEW', FALSE, 'Resultado Ana', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL)",
            "INSERT INTO candidate_attempts (id, empresa_id, company_id, result_id, simulation_id, simulation_version_id, simulation_version_number, idempotency_key, candidate_name, candidate_email, result_webhook_url, status, score, decision, human_review_required, company_result_string, created_at, started_at, finished_at, anonymized_at) VALUES ('attempt-match-2', 'empresa-1', '1', 'result-match-2', 'sim-atendimento-caos', 1, 1, 'idem-match-2', 'Bruno Lima', 'bruno@example.com', 'https://cliente.gupy.io/result-webhook', 'COMPLETED', 85, 'RECOMMEND_INTERVIEW', FALSE, 'Resultado Bruno', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL)",
    ...
    @Sql(scripts = "/empresa-isolation-fixtures.sql")
    @Sql(statements = {
            "INSERT INTO candidate_attempts (id, empresa_id, company_id, result_id, simulation_id, simulation_version_id, simulation_version_number, idempotency_key, candidate_name, candidate_email, result_webhook_url, status, score, decision, human_review_required, company_result_string, created_at, started_at, finished_at, anonymized_at) VALUES ('attempt-match-safe', 'empresa-1', '1', 'result-match-safe', 'sim-atendimento-caos', 1, 1, 'idem-match-safe', 'Carla Nunes', 'carla@example.com', 'https://cliente.gupy.io/result-webhook', 'COMPLETED', 80, 'RECOMMEND_INTERVIEW', FALSE, 'Resultado Carla', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL)",
            "INSERT INTO candidate_attempts (id, empresa_id, company_id, result_id, simulation_id, simulation_version_id, simulation_version_number, idempotency_key, candidate_name, candidate_email, result_webhook_url, status, score, decision, human_review_required, company_result_string, created_at, started_at, finished_at, anonymized_at) VALUES ('attempt-match-empresa2', 'empresa-2', '2', 'result-match-empresa2', 'sim-empresa2', 9001, 1, 'idem-match-empresa2', 'Outro Empresa', 'empresa2@example.com', 'https://cliente.gupy.io/result-webhook', 'COMPLETED', 88, 'RECOMMEND_INTERVIEW', FALSE, 'Resultado Empresa 2', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL)"
    })
