...
public enum AuditEventType implements DescribedEnum {
    ...
    TALENT_NORMATIVE_GROUP_CONFIGURED("talentNormativeGroupConfigured"),
    TALENT_DECISION_THRESHOLD_CONFIGURED("talentDecisionThresholdConfigured"),
    TALENT_REFERENCE_SNAPSHOT_CAPTURED("talentReferenceSnapshotCaptured"),
    HUMAN_DECISION("humanDecision"),
    INTERVIEW_GUIDE_RECORDED("interviewGuideRecorded"),
    ...
    INTEGRATION_ACTIVITY_RECORDED("integrationActivityRecorded"),
